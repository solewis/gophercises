...
func (_ human) Bet(minBet money.USD, maxBet money.USD, _ bool) money.USD {
...
func (_ human) HandResults(hand, dealer []deck.Card, winnings, balance money.USD) {
...
func (_ human) RoundRecap(allHands [][]deck.Card) {}
